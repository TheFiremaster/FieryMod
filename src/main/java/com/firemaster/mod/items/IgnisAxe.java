...
public class IgnisAxe extends ItemAxe {
	...
	public boolean onBlockStartBreak(ItemStack itemstack, int X, int Y, int Z, EntityPlayer player) {
		...
		if (player.worldObj.isRemote || block == null || EnchantmentHelper.getSilkTouchModifier(player) || !block.isToolEffective("axe", itemstack.getItem().getMetadata(0))) {
			return false;
		}
		...
		System.out.println("Item type: " + blockItem.getItem().getUnlocalizedName());
		
		// Manually damage the axe and delete the block.
